...
import useSwitchStyles from "./hooks/SwitchStyles";
import { useSpring, animated } from "react-spring";
import { freeuniData, agruniData } from "./constants/EmisData";
    ...
    <div className={classes.root}>
      <AppBar className={classes.appBar}>
        <Toolbar>
          ...
          <Switch classes={switchStyles} onChange={props.switchChangeHandler} />
